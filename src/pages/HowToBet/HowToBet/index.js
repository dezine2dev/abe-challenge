...
export default () => {
  return (
    <Fragment>
      <h2 className="mb-4">How To Bet</h2>
      <div className="text-secondary font-20">
        This is the place to learn how to bet, become a more effective bettor, or learn if
        sports betting is legal in your state. Check out our helpful sports betting
        tutorials and bet smarter today.
      </div>
      <SignupCard />
