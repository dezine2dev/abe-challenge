  ...
  return (
    <Fragment>
      ...
      <p>
        ...
        your sports betting journey: moneyline, spread and total (also referred to as the
        over/under). Before we start digging into jargon, let's take a moment to consider
      ...
      <p>
        ...
        will have a positive value next to its name (Chicago Bulls +120, for example), and
        the other team will have a negative value next to its name (such as Toronto
      ...
      <p>
        ...
        <span className="text-primary font-weight-semibold">here</span> if you feel ready.
      </p>
      ...
      <p>
        ...
        to determine their score for betting purposes.
      </p>
      <p>
      ...
      <p>
        But when there's a point spread involved, you need to know just how much smacking
        the Patriots have in store for Detroit's finest.
      </p>
      ...
      <p>
        As a spread bettor, it's your job to decide whether the Lions will win or lose by
        more or less than 14 points. If you took the Pats and they grab a W with a final
        of 24-13, you lose the bet because the margin of victory was 11, which our
      ...
      <p>
        ...
        known to score a point or two. The oddsmakers (and their algorithms) might examine
        the teams' respective stats from the past couple of weeks and decide, "Denver's
        gonna put up 115, and Houston will score 110, so the over/under on the game will
        be 225." It's then up to you whether you believe the two teams will play a high
        scoring game (in which case you take the over) or whether good defense will keep
        the scoring low (take the under).
      </p>
      <p>
      ...
      <p className="mb-5 go-to-next text-right">
